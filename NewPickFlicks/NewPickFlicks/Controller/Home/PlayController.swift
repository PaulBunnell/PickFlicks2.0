...
class PlayController: UIViewController {
    ...
    private let topStack = PlayNavigationStackView()
    private let bottomStack = PlayBottomControllerStackView()
...
extension PlayController: HomeNavigationStackViewDelegate {
